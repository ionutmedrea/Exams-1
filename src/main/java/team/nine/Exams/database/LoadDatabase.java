...
public class LoadDatabase {
    ...
    CommandLineRunner initDatabase (ExamRepository repository){
        return args -> {
            log.info("Preloading " + repository.save(new Exam(2020, "Iarna P1", 1, "AC", "CTI", "LSD", "Minea", 150)));
            log.info("Preloading " + repository.save(new Exam(2020, "Vara P2", 2, "AC", "ISE", "TS1", "Robu", 200)));
        };
